...
const industries = [
  ...
  },
  {
    ...
    image: "/industries/electricians.jpg",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    image: "/industries/medical-dental.jpg",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {industries.map((industry, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl border border-[#E2E8F0] hover:border-[#2563EB]/30 hover:shadow-md transition-all group overflow-hidden"
            >
              <div className="relative h-36 w-full">
                ...
                <div className="absolute bottom-3 left-3 w-10 h-10 rounded-xl bg-white/95 backdrop-blur-sm text-[#2563EB] flex items-center justify-center shadow-sm">
                  {industry.icon}
                </div>
              </div>
              <div className="p-6">
