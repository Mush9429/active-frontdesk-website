...
const features = [
  {
    ...
    description: "Every call picked up in seconds, day or night. Natural Australian voice using your business name.",
    icon: (
  ...
  },
  {
    ...
    description: "Checks your real calendar and books confirmed appointments on the spot. No double-bookings.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Customers get an instant text confirming their booking. Professional and reassuring.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Every caller's name, number, and job details logged automatically. No leads slip through.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Burst pipes, gas leaks, flooding? Calls get routed straight to your mobile, instantly.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "See exactly how many calls were answered, jobs booked, and revenue recovered. Every Monday.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-[#475569] text-lg max-w-2xl mx-auto">
            A complete system that handles every call from first ring to confirmed booking.
          </p>
        </div>
